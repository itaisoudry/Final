...
SP_LOGGER_MSG spLoggerPrintError(const char* msg, const char* file,
	...
	//TODO - change to fwrite to file
	printf("%s", ERROR_TITLE);
	printf("%s %s", FILE_TITLE, file);
	printf("%s %s", FUNCTION_TITLE, function);
	printf("%s %s", LINE_TITLE, line);
	printf("%s %s", MESSAGE_TITLE, msg);
	return SP_LOGGER_SUCCESS;
